...
/// </remarks>
public static class StripRedundantTerms
{
    private static readonly IReadOnlyList<string> RedundantHamcrestPrefixes =
        ["is ", "be ", "should be"];

    /// <summary>
    ///     Removes predefined redundant terms from the given expression string.
    /// </summary>
    /// <param name="expression">
    ///     The input string from which redundant prefixes will be removed. Can be null.
    /// </param>
    /// <returns>
    ///     A string with redundant prefixes stripped, or null if the input expression is null.
    /// </returns>
