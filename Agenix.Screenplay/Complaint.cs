...
/// <summary>
/// Represents a class for generating exceptions of a specific type based on complaint details and actual error information.
/// </summary>
public class Complaint
{
    private const string NoValidConstructor = "{0} should have a constructor with the signature MyException(string message) and MyException(string message, Exception cause)";

    /// <summary>
    /// Creates an exception of the specified type using the provided complaint details and the actual error information.
    /// </summary>
    /// <param name="complaintType">The type of the exception to be created. Must have a constructor that accepts a string and an exception as parameters.</param>
    /// <param name="complaintDetails">Optional details about the complaint. Can be null if only the actual error message is needed.</param>
    /// <param name="actualError">The original exception that caused the complaint. Must not be null.</param>
    /// <returns>Returns an exception of the specified type with the provided details, or an <see cref="AssertionException"/> if a suitable constructor is not found.</returns>
    ...
    /// <param name="actualError">The original exception that caused the complaint. Must not be null.</param>
    /// <returns>Returns a string that combines the complaint details and the actual error message. If one of them is null, the available message is returned.</returns>
    ...
    /// </summary>
    /// <param name="complaintType">The type of the exception to create. It must have a valid constructor to accept the provided parameters.</param>
    /// <param name="complaintDetails">The additional details to describe the complaint. Can be null if the actual error message is sufficient.</param>
    /// <param name="actualError">The original exception that caused this complaint.</param>
    /// <returns>Returns an exception object of the specified type with the provided details or throws an <see cref="AssertionException"/> if a valid constructor is not found.</returns>
