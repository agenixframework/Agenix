...
#pragma warning restore CS0649 // Field is never assigned to, and will always have its default value
    ...
    {
        Assert.DoesNotThrowAsync(() => _runner.Run(Echo("Project name is: ${project.name}")));
        Assert.DoesNotThrowAsync(() => _runner.Run(Echo("Testing global variables: ${globalWelcomingText}")));
    }
}
