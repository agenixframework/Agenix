...
namespace Agenix.Core.Tests.IO
{
    ...
    public class AssemblyResourceTest
    {
        ...
        {
            Assert.Throws<UriFormatException>(() => new AssemblyResource("assembly://Agenix.Core.Tests,Agenix.Core.Tests.TestResource.txt"));
        }
        ...
        {
            Assert.Throws<FileNotFoundException>(() => new AssemblyResource("assembly://Xyz.Invalid.Assembly/Agenix.Core.Tests/TestResource.txt"));
        }
        ...
        {
            IResource res = new AssemblyResource("assembly://Agenix.Core.Tests/Agenix.Core.Tests/TestResource.txt");
            IResource res2 = res.CreateRelative("Agenix.Core.Tests/Agenix.Core.Tests.IO/TestResource.txt");
            AssertResourceContent(res2, "Agenix.Core.IO.TestResource.txt");
        }
        ...
        {
            IResource res = new AssemblyResource("assembly://Agenix.Core.Tests/Agenix.Core.Tests/TestResource.txt");
            IResource res2 = res.CreateRelative("/Agenix.Core.Tests.IO/TestResource.txt");
            AssertResourceContent(res2, "Agenix.Core.IO.TestResource.txt");
        }
