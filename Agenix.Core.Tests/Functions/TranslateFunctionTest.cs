...
public class TranslateFunctionTest : AbstractNUnitSetUp
{
    ...
    public void TestFunction()
    {
        ...
        Assert.That(_function.Execute(parameters, Context), Is.EqualTo("Hallo TestFramework"));
    }
    ...
    public void TestFunctionWithMoreComplexRegex()
    {
        ...
        Assert.That(_function.Execute(parameters, Context), Is.EqualTo("+1102367327996"));
    }
