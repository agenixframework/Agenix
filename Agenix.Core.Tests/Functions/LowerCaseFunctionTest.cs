...
public class LowerCaseFunctionTest : AbstractNUnitSetUp
{
    ...
    {
        Assert.That(_function.Execute(["1000"], Context), Is.EqualTo("1000"));
        Assert.That(_function.Execute(["hallo TestFramework!"], Context),
            Is.EqualTo("hallo testframework!"));
        Assert.That(_function.Execute(["Today is: 09.02.2012"], Context),
