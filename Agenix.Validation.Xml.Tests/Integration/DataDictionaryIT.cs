...
public class DataDictionaryIT
{
    ...
    [Test]
    public async Task DataDictionaryTest()
    {
        await runner.Given(CreateVariables().Variable("user", "Agenix"));
        await runner.Given(CreateVariables().Variable("correlationId", "agenix:RandomNumber(10)"));
        await runner.Given(CreateVariables().Variable("messageId", "agenix:RandomNumber(10)"));
        ...
        await runner.Then(TraceVariables("id", "correlationId", "operation", "messageId", "user"));
    }
