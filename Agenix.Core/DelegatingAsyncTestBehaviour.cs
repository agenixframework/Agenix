...
public class DelegatingAsyncTestBehaviour(AsyncTestBehavior testBehavior) : IAsyncTestBehavior
{
    /// <summary>
    ...
    public Task Apply(IAsyncTestActionRunner runner)
    {
        return testBehavior.Invoke(runner);
    }
}
