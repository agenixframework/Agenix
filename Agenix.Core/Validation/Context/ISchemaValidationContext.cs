...
public interface ISchemaValidationContext
{
    ...
    /// </summary>
    /// <returns>True if schema validation is enabled; otherwise, false.</returns>
    bool IsSchemaValidationEnabled();

    /// <summary>
    ///     Gets the schema repository.
    /// </summary>
    /// <returns>The schema repository.</returns>
    ...
    public interface IBuilder<out TB>
    {
        /// <summary>
