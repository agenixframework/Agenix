...
///     message payloads into a String representation in order to perform text equals validation. Both received and control
///     message should have textual message payloads. By default, the validator ignores leading and trailing whitespaces
