...
public class XpathMessageValidationContext : XmlMessageValidationContext, IValidationContext
{
    ...
    /// /
    public new sealed class Builder : XmlValidationContextBuilder<XpathMessageValidationContext, Builder>, IWithExpressions<Builder>, IVariableExtractorAdapter, IMessageProcessorAdapter
    {
        ...
        /// <param name="expressions">A dictionary containing key-value pairs of expressions to be associated with the context builder.</param>
