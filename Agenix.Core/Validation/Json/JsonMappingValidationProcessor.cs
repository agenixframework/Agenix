    ...
    : AbstractValidationProcessor<T>
{
    ...
    /// <exception cref="CoreSystemException">Thrown when the JSON payload cannot be deserialized.</exception>
    private T ReadJson(IMessage message)
    {
        ...
        {
            throw new CoreSystemException("Failed to unmarshal message payload", e);
        }
    }
    ...
    /// <exception cref="CoreSystemException">Thrown when validation of the JSON payload fails.</exception>
        ...
        IReferenceResolverAware
    {
        ...
        /// <exception cref="CoreSystemException">Thrown when the JsonSerializer or validation processor is not set.</exception>
        public JsonMappingValidationProcessor<TB> Build()
        {
            ...
            if (_validationProcessor == null)
                throw new CoreSystemException("Missing validation processor - please add proper validation logic");
