...
public class JsonElementValidator(bool strict, TestContext context, ICollection<string> ignoreExpressions)
{
    ...
    /// <summary>
    ///     Checks if a control entry is ignored based on placeholders or a list of ignore expressions.
    /// </summary>
    /// <param name="ignoreExpressions">A collection of ignore expressions.</param>
        ...
        JsonElementValidatorItem<object> controlEntry)
    {
        ...
        return trimmedControlValue.Equals(CoreSettings.IgnorePlaceholder) ||
