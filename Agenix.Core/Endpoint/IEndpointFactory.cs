...
/// <summary>
///     Endpoint factory tries to get endpoint instance by parsing an endpoint uri. Uri can have parameters that get passed
///     to the endpoint configuration. If Spring application context is given searches for matching endpoint component bean
///     and delegates to component for endpoint creation.
/// </summary>
