...
public interface ITestActionContainerBuilder<out T, out TS> : IAsyncTestActionBuilder<T>
    ...
    where TS : class
{
    ...
    /// /
    TS Actions(params IAsyncTestAction[] actions);

    /// Adds test actions to the action container.
    /// @param actions An array of actions to be added.
    /// @return The updated instance of the action container builder.
    TS Actions(params IAsyncTestActionBuilder<IAsyncTestAction>[] actions);
