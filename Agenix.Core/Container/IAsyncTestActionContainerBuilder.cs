...
public interface IAsyncTestActionContainerBuilder<out T, out S> : IAsyncTestActionBuilder<T>
    ...
    where S : class
{
    ...
    /// /
    S Actions(params IAsyncTestAction[] actions);

    /// Adds test actions to the action container.
    /// @param actions An array of actions to be added.
    /// @return The updated instance of the action container builder.
    S Actions(params IAsyncTestActionBuilder<IAsyncTestAction>[] actions);

    /// Get the list of test actions for this container.
    /// @return List of test actions.
    List<IAsyncTestActionBuilder<IAsyncTestAction>> GetActions();
}
