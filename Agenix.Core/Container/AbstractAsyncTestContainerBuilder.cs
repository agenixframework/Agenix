...
/// <summary>
///     Abstract base class providing asynchronous builder capabilities for constructing test action containers.
/// </summary>
/// <typeparam name="T">Type that implements IAsyncTestActionContainer.</typeparam>
/// <typeparam name="TS">Type that implements both IAsyncTestActionContainerBuilder and IAsyncTestActionBuilder.</typeparam>
public abstract class AbstractAsyncTestContainerBuilder<T, TS> : AbstractAsyncTestActionBuilder<T, TS>,
    IAsyncTestActionContainerBuilder<T, TS>
    where T : IAsyncTestActionContainer
    where TS : class
{
    /// <summary>
    ///     Maintains a list of asynchronous test action builders associated with the test action container builder.
    /// </summary>
    /// <remarks>
    ///     Used to store and manage instances of <see cref="IAsyncTestActionBuilder{T}" />
    ///     that are responsible for constructing asynchronous test actions.
    ///     This variable is manipulated through various action registration methods
    ///     and contributes to the eventual construction of the test action container.
    /// </remarks>
