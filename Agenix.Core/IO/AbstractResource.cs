...
{
    /// <summary>
    /// Convenience base class for <see cref="Agenix.Core.IO.IResource"/>
    /// implementations, pre-implementing typical behavior.
    /// </summary>
    /// <remarks>
    /// <p>
    /// The <see cref="Agenix.Core.IO.AbstractResource.Exists"/> method will
    /// check whether a <see cref="System.IO.FileInfo"/> or
    /// <see cref="System.IO.Stream"/> can be opened;
    /// <see cref="Agenix.Core.IO.AbstractResource.IsOpen"/> will always return
    /// <see langword="false"/>;
    /// <see cref="Agenix.Core.IO.AbstractResource.Uri"/> and
    /// <see cref="Agenix.Core.IO.AbstractResource.File"/> throw an exception;
    /// and <see cref="Agenix.Core.IO.AbstractResource.ToString()"/> will
    /// return the value of the
    /// <see cref="Agenix.Core.IO.IResource.Description"/> property.
    /// </p>
    /// </remarks>
    ...
    public abstract class AbstractResource : IResource
    {
        ...
        /// <remarks>
        /// <p>
        /// Will be resolved (by those <see cref="Agenix.Core.IO.IResource"/>
        /// implementations that support it) to the home (or root) path for
        /// the specific <see cref="Agenix.Core.IO.IResource"/> implementation.
        /// </p>
        /// <p>
        ...
        private readonly string _basePathPlaceHolder = DefaultBasePathPlaceHolder;
        ...
        protected AbstractResource(string resourceName)
        {
            ...
            _protocol = ConfigurableResourceLoader.GetProtocol(resourceName);
        ...
        /// </p>
        /// </remarks>
        /// <seealso cref="Agenix.Core.IO.AbstractResource.DefaultBasePathPlaceHolder"/>
        public string BasePathPlaceHolder => _basePathPlaceHolder;
        ...
        /// </exception>
        /// <seealso cref="Agenix.Core.IO.IInputStreamSource.InputStream"/>
        ...
        /// <summary>
        /// Does this <see cref="Agenix.Core.IO.IResource"/> support relative
        /// resource retrieval?
        /// </summary>
        /// <remarks>
        /// <p>
        ...
        /// <see cref="Agenix.Core.IO.IResource.CreateRelative"/>).
        /// </p>
        /// <p>
        /// This, the default implementation, always returns
        /// <see langword="false"/>.
        ...
        /// <see cref="Agenix.Core.IO.IResource"/> supports relative resource
        /// retrieval.
        /// </value>
