...
/// </summary>
public class SubstringAfterFunction : IFunction
{
    /// <summary>
    ///     Executes the SubstringAfterFunction, which returns the substring after the first occurrence of a search string.
    /// </summary>
    ...
    /// <returns>Returns the substring after the first occurrence of the search string.</returns>
    ...
    public string Execute(List<string> parameterList, TestContext testContext)
    {
        ...
        if (parameterList.Count > 1)
        {
            ...
            resultString =
                resultString[(resultString.IndexOf(searchString, StringComparison.Ordinal) + searchString.Length)..];
        }
