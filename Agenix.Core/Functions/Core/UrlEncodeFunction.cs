...
{
    /// <summary>
    ///     Executes the URL encode function.
    /// </summary>
    /// <param name="parameterList">List of parameters: [0] - string to encode, [1] - charset (optional, defaults to UTF-8)</param>
    ...
    public string Execute(List<string> parameterList, TestContext testContext)
    {
        ...
        try
        {
            ...
            return HttpUtility.UrlEncode(parameterList[0], encoding);
        }
