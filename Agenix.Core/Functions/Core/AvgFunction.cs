...
{
    /// <summary>
    ///     Executes the average function on the provided parameter list.
    /// </summary>
    /// <param name="parameterList">List of numeric string values</param>
    /// <param name="testContext">Test context</param>
    /// <returns>The average of all numeric values as a string</returns>
    ...
    public string Execute(List<string> parameterList, TestContext testContext)
    {
        ...
        var result = parameterList.Sum(ParseDouble);

        return (result / parameterList.Count).ToString(CultureInfo.InvariantCulture);
    }
