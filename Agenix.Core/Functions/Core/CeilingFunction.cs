...
{
    /// <summary>
    ///     Executes the ceiling function on the first parameter.
    /// </summary>
    /// <param name="parameterList">List containing at least one numeric string value</param>
    /// <param name="testContext">Test context</param>
    /// <returns>The ceiling of the numeric value as a string</returns>
    ...
    public string Execute(List<string> parameterList, TestContext testContext)
    {
        ...
        return Math.Ceiling(ParseDouble(parameterList[0])).ToString(CultureInfo.InvariantCulture);
    }
