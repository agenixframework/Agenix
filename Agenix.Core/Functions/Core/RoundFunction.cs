...
{
    /// <summary>
    ///     Executes the round function on the provided parameters.
    /// </summary>
    /// <param name="parameterList">The list of parameters containing the decimal value to round</param>
    /// <param name="testContext">The test context</param>
    /// <returns>The rounded integer value as a string</returns>
    ...
    public string Execute(List<string> parameterList, TestContext testContext)
    {
        ...
        return Math.Round(double.Parse(parameterList[0])).ToString(CultureInfo.InvariantCulture);
    }
}
