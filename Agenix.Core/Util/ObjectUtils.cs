...
namespace Agenix.Core.Util
{
    ...
    {
        /// <summary>
        /// The <see cref="log4net.ILog"/> instance for this class.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ObjectUtils"/> class.
        /// </summary>
        /// <remarks>
        /// <p>
        ...
        public static object InstantiateType(ConstructorInfo constructor, object[] arguments)
        {
            ...
            if (Log.IsDebugEnabled) Log.Debug(
                $"instantiating type [{constructor.DeclaringType}] using constructor [{constructor}]");
