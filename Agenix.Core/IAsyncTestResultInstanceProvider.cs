...
/// </summary>
public interface IAsyncTestResultInstanceProvider
{
    /// <summary>
    ...
    TestResult CreateSuccess(IAsyncTestCase testCase);
    ...
    TestResult CreateFailed(IAsyncTestCase testCase, Exception ex);
    ...
    TestResult CreateSkipped(IAsyncTestCase testCase);
}
