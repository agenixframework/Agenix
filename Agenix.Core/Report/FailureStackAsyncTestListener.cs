...
/// </summary>
public class FailureStackAsyncTestListener : AbstractAsyncTestListener
{
    /// <summary>
    ///     Logger.
    /// </summary>
    ...
    /// <summary>
    ///     Handles the failure of a test asynchronously, and updates the failure stack
    ///     for the provided asynchronous test case if the exception is an AgenixSystemException.
    /// </summary>
    /// <param name="test">
    ///     The asynchronous test case that has failed.
    /// </param>
    /// <param name="cause">
    ...
    /// </returns>
    public override Task OnTestFailure(IAsyncTestCase test, Exception cause)
    {
    ...
    /// <returns></returns>
    public static List<FailureStackElement> GetFailureStack(IAsyncTestCase test)
    {
    ...
    private sealed class FailureStackContentHandler
    {
        ...
        /// </summary>
        private readonly IAsyncTestCase _test;
        ...
        public FailureStackContentHandler(List<FailureStackElement> failureStack, IAsyncTestCase test,
            string testFilePath)
        {
    ...
    private sealed class FailureStackFinder
    {
        ...
        ///     Action list
        /// </summary>
        private readonly Stack<IAsyncTestAction> _actionStack = new();
        ...
        public FailureStackFinder(IAsyncTestActionContainer container)
        {
        ...
        public bool IsFailureStackElement(string eventElement)
        {
            ...
            {
                if (_action is IAsyncTestActionContainer container && _actionStack.Count > 0)
                {
        ...
        public IAsyncTestActionContainer GetNestedActionContainer()
        {
            if (_action is IAsyncTestActionContainer container)
            {
                return container;
            }
