...
namespace Agenix.Validation.Json.Validation.Schema
{
    ...
    public class JsonSchemaValidation(JsonSchemaFilter jsonSchemaFilter) : ISchemaValidator<ISchemaValidationContext>
    {
        ...
        ///     Logger.
        /// </summary>
        private static readonly ILog Log = LogManager.GetLogger(nameof(JsonSchemaValidation));
        ...
        {
            return AgenixSettings.IsOutboundSchemaValidationEnabled() || AgenixSettings.IsOutboundJsonSchemaValidationEnabled();
        }
