...
namespace Agenix.GraphQL.Server
{
        ...
        where TBuilder : AbstractGraphQLServerBuilder<TServer, TBuilder>
    {
        ...
        /// Query resolvers
        /// </summary>
        private readonly Dictionary<string, Func<Dictionary<string, object>, object, Task<object>>> _queryResolvers =
            new();

        /// <summary>
        /// Mutation resolvers
        /// </summary>
        private readonly Dictionary<string, Func<Dictionary<string, object>, object, Task<object>>> _mutationResolvers =
            new();

        /// <summary>
        /// Subscription resolvers
        /// </summary>
        private readonly Dictionary<string, Func<Dictionary<string, object>, object, Task<object>>>
            _subscriptionResolvers = new();
