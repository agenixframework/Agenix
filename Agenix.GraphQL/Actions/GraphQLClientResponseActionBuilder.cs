    ...
    GraphQLClientResponseActionBuilder.GraphQLMessageBuilderSupport, GraphQLClientResponseActionBuilder>
{
    ...
    /// <summary>
    ///     Facilitates the construction of a GraphQL client response action by providing a fluent API for configuring message
    ///     handling behaviors.
    ///     This builder initializes a `GraphQLMessage` instance and wraps it with a `GraphQLMessageBuilder` for extended
    ///     configuration.
    ///     It ensures response handling adheres to the needs of GraphQL message processing, supporting customizations like
    ...
    ///     Inherits behavior from `ReceiveMessageAction.ReceiveMessageActionBuilder` to support advanced message processing
    ///     capabilities.
    /// </summary>
    ...
    ///     This method aggregates and applies properties, processors, validators, and message building details defined within
    ///     the builder
    ...
    {
        private readonly GraphQLMessage graphQLMessage = graphQLMessage;
        ...
        /// <summary>
        ///     Sets whether WebSocket should be used for this GraphQL message and returns the current builder instance for method
        ///     chaining.
        /// </summary>
