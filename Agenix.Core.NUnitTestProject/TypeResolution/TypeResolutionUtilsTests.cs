...
public sealed class TypeResolutionUtilsTests
{
    ...
    public void ResolveFromAssemblyQualifiedName()
    {
        var testObjectType =
            TypeResolutionUtils.ResolveType(
                "Agenix.Core.NUnitTestProject.TypeResolution.TestObject, Agenix.Core.NUnitTestProject");
    ...
    public void ResolveFromBadAssemblyQualifiedName()
    {
        Assert.Throws<TypeLoadException>(() =>
            TypeResolutionUtils.ResolveType(
                "Agenix.Core.NUnitTestProject.TypeResolution.TestObject, Agenix.Core.FooTests"));
    }

    [Test]
    public void ResolveFromShortName()
    {
        var testObjectType = TypeResolutionUtils.ResolveType("Agenix.Core.NUnitTestProject.TypeResolution.TestObject");
        ClassicAssert.IsNotNull(testObjectType);
        ClassicAssert.IsTrue(testObjectType.Equals(typeof(TestObject)));
    }
    ...
    {
        Assert.Throws<TypeLoadException>(() =>
            TypeResolutionUtils.ResolveType("Agenix.Core.NUnitTestProject.TypeResolution.FooBarTestObject"));
    }
