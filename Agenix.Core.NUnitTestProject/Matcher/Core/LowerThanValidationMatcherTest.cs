...
{
    public class LowerThanValidationMatcherTest : AbstractNUnitSetUp
    {
        private readonly LowerThanValidationMatcher _matcher = new();

        [Test]
        public void TestValidateSuccess()
        {
            _matcher.Validate("field", "2", new List<string> { "3" }, Context);
        ...
        public void TestValidateError()
        {
            ...
            AssertException("field", "2.1", new List<string> { "2.0" });
        }
