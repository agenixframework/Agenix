...
public class ExecuteSqlQueryActionTest : AbstractNUnitSetUp
{
    ...
    {
        // Bridge async AdoTemplate query APIs to existing sync setups without recursion and with correct return types
        ...
        _adoTemplate.Setup(t => t.QueryWithRowMapperAsync(It.IsAny<CommandType>(), It.IsAny<string>(),
            ...
            .Returns((CommandType ct, string sql, ExecuteSqlQueryAction.DictionaryRowMapper rm, DbConnection c,
                ...
                Task.FromResult<IList>(_adoTemplate.Object.QueryWithRowMapperAsync(ct, sql, rm)));
    }
    ...
    [Test]
    public async Task TestSqlStatement()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
        BridgeAsyncToSync();
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), It.IsAny<string>(),
        ...
        await _executeSqlQueryAction.Build().ExecuteAsync(Context);
    ...
    [Test]
    public async Task TestSqlStatementWithTransaction()
    {
        // Reset mocks
        _adoTemplate.Reset();
        BridgeAsyncToSync();
        ...
        // Setup ADO template mock
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), It.IsAny<string>(),
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
            .Returns(new List<Dictionary<string, object>> { resultMap });

        // Execute the SQL query action inside ADO.NET transaction
        _executeSqlQueryAction.Statements([DbStmt1]);
        _executeSqlQueryAction.UseTransaction(true);
        _executeSqlQueryAction.TransactionIsolationLevel("ReadCommitted");
        _executeSqlQueryAction.TransactionTimeout(5000);
        _executeSqlQueryAction.Extract("ORDERTYPE", "orderType");
        _executeSqlQueryAction.Extract("STATUS", "status");
        await _executeSqlQueryAction.Build().ExecuteAsync(Context);
    ...
    [Test]
    public async Task TestSqlStatementLowerCaseColumnNames()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestSqlMultipleStatements()
    {
        var sql1 = DbStmt1;
        var sql2 = DbStmt2;
        var sql3 = DbStmt3;
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), sql1,
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), sql2,
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), sql3,
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
    ...
    [Test]
    public async Task TestNullValue()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), sql,
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
            .Returns(new List<Dictionary<string, object>> { resultMap });
    ...
    [Test]
    public async Task TestVariableSupport()
    {
        ...
        _adoTemplate
            .Setup(j => j.QueryWithRowMapperAsync(It.IsAny<CommandType>(), DbStmt1,
                It.IsAny<ExecuteSqlQueryAction.DictionaryRowMapper>()))
            .Returns(new List<Dictionary<string, object>> { resultMap });
    ...
    [Test]
    public async Task TestExtractToVariablesLowerCaseColumnNames()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestResultSetValidation()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestResultSetValidationLowerCase()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestResultSetValidationWithAliasNames()
    {
    ...
    [Test]
    public async Task TestResultSetValidationError()
    {
        var sql = DbStmt1;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestResultSetMultipleRowsValidation()
    {
    ...
    [Test]
    public async Task TestIgnoreInMultipleRowsValidation()
    {
        var sql = "select ORDERTYPE, STATUS from orders where ID < 5";
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestExtractMultipleRowValues()
    {
        const string sql = "select distinct STATUS from orders";
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestMultipleStatementsValidationError()
    {
        var sql1 = DbStmt1;
        var sql2 = DbStmt2;
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestSqlStatementsWithFileResource()
    {
        _adoTemplate.Reset();
    ...
    [Test]
    public async Task TestResultSetValidationWithVariableAndFunction()
    {
        var sql = DbStmt1;
    ...
    [Test]
    public async Task TestBinaryBlobColumnValues()
    {
        const string sql = "select ORDERTYPE, BINARY_DATA from orders where ID=5";
