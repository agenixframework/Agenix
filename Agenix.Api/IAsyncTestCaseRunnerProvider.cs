...
/// <summary>
///     Defines a provider for creating instances of asynchronous test case runners capable of executing specific test
///     cases
///     within a provided execution context.
/// </summary>
public interface IAsyncTestCaseRunnerProvider
{
    ...
    /// /
    IAsyncTestCaseRunner CreateTestCaseRunner(IAsyncTestCase testCase, TestContext context);
    ...
    /// /
    IAsyncTestCaseRunner CreateTestCaseRunner(TestContext context);
}
