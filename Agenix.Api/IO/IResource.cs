...
public interface IResource : IInputStreamSource
{
    ...
    {
        return GetReader(Encoding.GetEncoding(AgenixSettings.AgenixFileEncoding()));
    }
     ...
     */
    /// <summary>
    ///     Returns a <see cref="System.IO.TextReader" /> to read from the underlying resource using the specified character
    ///     encoding.
    /// </summary>
    /// <param name="charset">
