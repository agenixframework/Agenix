...
public sealed class TypeRegistry
{
    ...
    static TypeRegistry()
    {
        lock (syncRoot)
        {
            ...
            types[Int32AliasVB] = typeof(int);
            types[Int32ArrayAlias] = typeof(int[]);
            types[Int32ArrayAliasVB] = typeof(int[]);
            ...
            types[Int16AliasVB] = typeof(short);
            types[Int16ArrayAlias] = typeof(short[]);
            types[Int16ArrayAliasVB] = typeof(short[]);
            ...
            types[Int64AliasVB] = typeof(long);
            types[Int64ArrayAlias] = typeof(long[]);
            types[Int64ArrayAliasVB] = typeof(long[]);
    ...
    /// <summary>
    ///     Name of the .Net config section that contains Agenix type aliases.
    /// </summary>
    private const string TypeAliasesSectionName = "agenix/typeAliases";
