...
public sealed class ReflectionUtils
{
    ...
    /// <remarks>
    /// <para>Searches with BindingFlags</para>
    /// <para>When dealing with interface methods, you probably want to 'normalize' method references by calling
    /// <see cref="MapInterfaceMethodToImplementationIfNecessary"/>.
    /// </para>
    /// </remarks>
    /// <param name="targetType">
        ...
        Type targetType, string method, Type[] argumentTypes, int genericArgumentsCount)
    {
        ...
        foreach (MethodInfo candidate in methods)
        {
            ...
            {
                var parameterTypes = Array.ConvertAll(candidate.GetParameters(), delegate(ParameterInfo i) { return i.ParameterType; });
