...
/// </summary>
public interface IAsyncTestActionListener
{
    /// <summary>
    ...
    Task OnTestActionStart(IAsyncTestCase testCase, IAsyncTestAction testAction);
    ...
    Task OnTestActionFinish(IAsyncTestCase testCase, IAsyncTestAction testAction);
    ...
    Task OnTestActionSkipped(IAsyncTestCase testCase, IAsyncTestAction testAction);
}
