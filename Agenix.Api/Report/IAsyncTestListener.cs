...
public interface IAsyncTestListener
{
    ...
    Task OnTestFailure(IAsyncTestCase test, Exception cause);

    /// Invoked when test is skipped
    /// <param name="test">Test case that is being skipped</param>
    Task OnTestSkipped(IAsyncTestCase test);
}
