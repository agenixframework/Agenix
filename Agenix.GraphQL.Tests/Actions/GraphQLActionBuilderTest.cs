...
public class GraphQLActionBuilderTest
{
    ...
    {
        var endpointBuilders = IAsyncTestActionBuilder<IAsyncTestAction>.Lookup();
        Assert.That(endpointBuilders.ContainsKey("graphql"), Is.True);

        var graphqlBuilder = IAsyncTestActionBuilder<IAsyncTestAction>.Lookup("graphql");
    ...
    {
        Assert.That(_fixture, Is.InstanceOf<AbstractReferenceResolverAwareTestActionBuilder<IAsyncTestAction>>(),
