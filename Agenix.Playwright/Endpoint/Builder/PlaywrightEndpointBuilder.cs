...
namespace Agenix.Playwright.Endpoint.Builder;

/// <summary>
///     Static factory class for creating Playwright endpoint builders.
///     Provides a convenient entry point for building Playwright browser endpoints using a fluent API.
/// </summary>
public sealed class PlaywrightEndpoints : AbstractEndpointBuilder<PlaywrightBrowserBuilder>
{
    /// <summary>
    ///     Private constructor using browser builder implementation
    /// </summary>
    private PlaywrightEndpoints() : base(new PlaywrightBrowserBuilder())
    {
    }
