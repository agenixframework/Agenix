...
internal class SafeBindingInvoker : BindingInvoker
{
        ...
        object[] arguments, ITestTracer testTracer, DurationHolder durationHolder)
    {
        ...
        catch (Exception ex)
        {
            ...
            if (binding is not IHookBinding hookBinding)
            {
                throw;
            }

            if (hookBinding.HookType is HookType.BeforeScenario or HookType.BeforeScenarioBlock or HookType.BeforeStep
                or HookType.AfterStep or HookType.AfterScenario or HookType.AfterScenarioBlock)
            {
